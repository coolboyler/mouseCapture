...
export const ICONS = {
  Click: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m12 12 3-1 2 2-1 3-2 1z"/><path d="M5 8 2 11l3 3"/><path d="M19 8 22 11l-3 3"/><path d="M11 2 8 5l3 3"/><path d="M11 22 8 19l3-3"/></svg>
  ),
  Wait: (props: any) => (
  ...
  Key: (props: any) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4"/><path d="m15.5 7.5-3 3a1 1 0 0 1-1.4 0L9 8.4a1 1 0 0 1 0-1.4l3-3a1 1 0 0 1 1.4 0l2.1 2.1a1 1 0 0 1 0 1.4Z"/><circle cx="7.5" cy="15.5" r="5.5"/><path d="m11.4 11.4 2 2"/></svg>
  ),
  Move: (props: any) => (
